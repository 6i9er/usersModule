<script type="text/javascript" src="<?php echo e(url('plugins/parsleyjs/parsley.min.js')); ?>"></script>
<script type="text/javascript">
    $(document).ready(function(event) {
        $(".selectSubPermissions").on('click' , function () {
            if ($(this).attr("clicked") == '1'){
                $(this).attr("clicked" , '0')
                $(this).children().html("<?php echo e(trans('permissions.unSelectAll')); ?>")
                var that = $(this);
                ...
                $(this).attr("clicked" , '1')
                $(this).children().html("<?php echo e(trans('permissions.selectAll')); ?>")
                var that = $(this);
                that.parent().parent().next().children().children().each(function(){
    ...
    function addEditRoles() {
        ...
        // console.log(inputs);
        $.ajax({
            url:  "<?php echo e(route('adminAddEditRole')); ?>",
            method: 'POST',
            data: inputs,
            processData: false,
            contentType: false,
            success: function (data) {
                ...
                if(data['errors'] == "1"){
                    ...
                    if(data['is_edit'] == "1"){
                        var site ="<?php echo e(route('getAllRoles')); ?>" ;
